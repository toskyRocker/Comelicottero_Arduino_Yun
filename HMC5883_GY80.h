/***************************************************************************
  ...
  This is a library for the HMC5883 compass sensor. 
  These displays use I2C to communicate, 2 pins are required to interface.
 ***************************************************************************/
 
#ifndef HMC5883_GY80_H
#define HMC5883_GY80_H
...
#define HMC5883_ADDRESS (0x3C >> 1) //0011110x
...
typedef enum
    {
      HMC5883_MAGGAIN_0_88                       = 0x00,  // +/- 0.88
...
// HMC5883 Internal Variables
typedef struct hmc5883MagData_struct
    {
      float x;
      float y;
      float z;
